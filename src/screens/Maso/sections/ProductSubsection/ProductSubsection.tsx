...
export const ProductSubsection: React.FC<ProductSubsectionProps> = ({ onOpenForm }): JSX.Element => {
  const { t } = useTranslation("maso");
  const benefits = [t("product.benefit1"), t("product.benefit2")];
  ...
  return (
    <section className="flex flex-col items-center justify-between px-6 sm:px-6 md:px-8 lg:px-12 xl:px-[60px] py-8 sm:py-10 md:py-12 lg:py-[63px] w-full bg-white gap-8 sm:gap-10 md:gap-12 lg:gap-[63px]">
      <div className="flex flex-col w-full max-w-[1261px] gap-8 sm:gap-10 md:gap-12 lg:gap-[63px]">
        <article
          key="maso"
          className="flex flex-col lg:flex-row items-center justify-between gap-6 sm:gap-8 md:gap-10 lg:gap-[70px] lg:flex-row"
        >
