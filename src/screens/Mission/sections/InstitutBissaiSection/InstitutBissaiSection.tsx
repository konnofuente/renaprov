        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="order-2 lg:order-2 flex flex-col gap-6 md:gap-8">
            ...
            <p className="text-base md:text-lg leading-relaxed text-foundation-bluedarker">
              Un établissement d'enseignement supérieur reconnu pour la qualité
              de ses formations. L'Institut Universitaire Bissai prépare les
              jeunes aux métiers d'avenir grâce à des programmes adaptés, un
              corps enseignant qualifié et une ouverture sur l'innovation.
            </p>
