...
export const ComptePensionne: React.FC = () => {
  ...
  const features = [
    ...
    {
      icon: <CheckCircle className="w-6 h-6 text-foundation-bluenormal" />,
      title: "Services pensionnés",
      description: "Bénéficiez de services bancaires adaptés aux pensionnés et retraités."
    }
  ];

  const benefits = [
    "Gestion simplifiée de vos finances de retraite",
    "Services bancaires adaptés aux pensionnés",
    "Sécurité et fiabilité garanties",
    "Support client dédié aux retraités"
  ];

  return (
    <>
      <SEO
        title="Compte Pensionné - RENAPROV FINANCE SA"
        description="Gérez vos finances de retraite avec le compte pensionné RENAPROV. Services bancaires complets pour pensionnés et retraités."
        keywords="compte pensionné, retraite, RENAPROV, microfinance, Cameroun, virements, chèques, services bancaires, pensionnés"
      />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <p className="text-xl lg:text-2xl mb-8 text-blue-100">
                  Gérez vos finances de retraite avec des services bancaires complets et adaptés aux pensionnés
                </p>
                <Button 
                  size="lg" 
              ...
              >
                ...
                <div className="absolute -bottom-6 -right-6 bg-white p-4 rounded-lg shadow-lg">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm font-medium text-gray-700">Pour pensionnés</span>
                  </div>
                </div>
              </motion.div>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
            ...
            >
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Le compte pensionné vous permet de gérer efficacement vos finances de retraite avec des services adaptés.
              </p>
            </motion.div>
        ...
        <section className="py-16 lg:py-24 bg-gray-50">
          <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              >
                <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-6">
                  Pourquoi Choisir RENAPROV pour Votre Retraite ?
                </h2>
                <p className="text-lg text-gray-600 mb-8">
                  RENAPROV comprend les besoins spécifiques des pensionnés et propose des services adaptés à la retraite.
                </p>
          ...
          <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 text-center">
            ...
            >
              <h2 className="text-3xl lg:text-4xl font-bold mb-6">
                Prêt à Ouvrir Votre Compte Pensionné ?
              </h2>
              <p className="text-xl mb-8 text-blue-100">
                Rejoignez des milliers de pensionnés qui font confiance à RENAPROV pour leurs finances.
              </p>
              <Button 
                size="lg" 
                className="bg-white text-foundation-bluenormal hover:bg-gray-100"
