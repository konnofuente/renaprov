...
import { CheckCircle, ArrowRight, Phone, Mail, Globe, Building, Users, TrendingUp } from "lucide-react";
...
export const CompteCourantEntreprise: React.FC = () => {
  const features = [
    ...
    },
    {
      ...
      description: "Bénéficiez de services bancaires adaptés aux besoins de votre entreprise."
    }
  ];

  const benefits = [
    "Gestion simplifiée des finances de votre entreprise",
  ...
  return (
    <>
      <SEO
        title="Compte Courant Entreprise - RENAPROV FINANCE SA"
        description="Gérez les finances de votre entreprise avec le compte courant entreprise RENAPROV. Services bancaires complets pour entreprises et organisations."
        keywords="compte courant, entreprise, RENAPROV, microfinance, Cameroun, virements, chèques, services bancaires, PME"
      />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <p className="text-xl lg:text-2xl mb-8 text-blue-100">
                  Gérez les finances de votre entreprise avec des services bancaires complets et adaptés
                </p>
                <Button 
                  size="lg" 
          ...
          <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
            ...
            >
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Le compte courant entreprise vous permet de gérer efficacement les finances de votre organisation.
              </p>
            </motion.div>
        ...
        <section className="py-16 lg:py-24 bg-gray-50">
          <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              >
                <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-6">
                  Pourquoi Choisir RENAPROV pour Votre Entreprise ?
                </h2>
                <p className="text-lg text-gray-600 mb-8">
                  Avec plus de 30 ans d'expérience dans la microfinance au Cameroun, RENAPROV comprend les besoins des entreprises.
                </p>
          ...
          <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 text-center">
            ...
            >
              <h2 className="text-3xl lg:text-4xl font-bold mb-6">
                Prêt à Ouvrir Votre Compte Entreprise ?
              </h2>
              <p className="text-xl mb-8 text-blue-100">
                Rejoignez des milliers d'entreprises qui font confiance à RENAPROV pour leurs finances.
              </p>
              <Button 
                size="lg" 
                className="bg-white text-foundation-bluenormal hover:bg-gray-100"
